...
const AppHeader: FC = () => {
  ...
  return (
    <>
      ...
      {isMobile ? (
        ...
        <div className="flex flex-col items-center gap-1 text-center">
          ...
          <div className="app-header-description text-sm leading-tight">
            In-Browser DuckDB ● Analyze in Natural Language with AI ● No Remote Database Required.
          </div>
          <div className="app-header-credits text-sm" style={{color: 'rgba(255, 255, 255, 0.9)'}}>
            Credits: <a href="https://sqlrooms.org" target="_blank" rel="noopener noreferrer" className="app-header-link">sqlrooms.org</a> ● A Tigzig Custom Implementation
          </div>
        </div>
      ) : (
      ...
      {/* Download Info Bar - Subtle Professional Style */}
      <div
